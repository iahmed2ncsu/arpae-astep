...
def calculate_energy_use(year, energy_system_scenario, freight_demand_scenario, simulator_type="sts",factorup = 1.5):
    """
...
#    fleet_size_tender["BioDie"] = 9/7 * fleet_size_loco["BioDie"] * (tech_fraction["BioHyb"] / (tech_fraction["BioDie"] + tech_fraction["BioHyb"]))
    ...
    traffic_flows_for_Mod9["energy_system_scenario"] = energy_system_scenario
    #traffic_flows_for_Mod9["freight_demand_scenario"] = config["freight_demand_scenario"]
    traffic_flows_for_Mod9["freight_demand_scenario"] = freight_demand_scenario
    ...
    train_for_Mod9["energy_system_scenario"] = energy_system_scenario
    train_for_Mod9["freight_demand_scenario"] = freight_demand_scenario
    ...
    refueling_for_Mod9["energy_system_scenario"] = energy_system_scenario
    refueling_for_Mod9["freight_demand_scenario"] = freight_demand_scenario
    ...
    energy_for_Mod9["energy_system_scenario"] = energy_system_scenario
    energy_for_Mod9["freight_demand_scenario"] = freight_demand_scenario
