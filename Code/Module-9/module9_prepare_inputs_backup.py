...
def update_module9_templates(year, mod6_data, mod9_data, energy_system_scenario,freight_demand_scenario,
    ...
    mask_rows = (mod9_data['energy_system_scenario'] == energy_system_scenario) & \
        (mod9_data['freight_demand_scenario'] == freight_demand_scenario) & \
...
def update_module7_templates(year, mod6_data, mod9_data, energy_system_scenario,freight_demand_scenario, 
                             sort_cols=["energy_system_scenario", "freight_demand_scenario",
                                        "year", "region", "technology"]):
    """    
    ...
    # Define masks based on user settings config (energy_system_scenario, freight_demand_scenario, year)
    mask_rows9 = (mod9_data['energy_system_scenario'] == energy_system_scenario) & \
        (mod9_data['freight_demand_scenario'] == freight_demand_scenario) & \
        (mod9_data['year'] == int(year)) & \
        (mod9_data['technology'].isin(mod6_data["technology"].unique()))

    mask_rows7 = (mod6_data['energy_system_scenario'] == energy_system_scenario) & \
        (mod6_data['freight_demand_scenario'] == freight_demand_scenario) & \
...
def update_module8_templates(year, mod8_data, mod9_data, energy_system_scenario,freight_demand_scenario,
                             sort_cols=["energy_system_scenario", "freight_demand_scenario",
                                        "year", "region", "technology"]):
    """    
    The function updates the templates stored in Data/Template in conjunction
...
def prepare_inputs_for_module9(year, energy_system_scenario, freight_demand_scenario, 
                               save_mode="append", renewable_prices = "Moderate", oil_prices = "Low", h2_sub = "No"):
    """    
    ...
    df_module7["freight_demand_scenario"]=freight_demand_scenario
...
#     carbon_intensity_module7['freight_demand_scenario'] = carbon_intensity_module7['freight_demand_scenario'].replace({"population_shift": "Population Shift"})
    ...
    # Define masks based on user settings config (energy_system_scenario, freight_demand_scenario, year)
    mask_rows = (energy_price_module7['energy_system_scenario'] == energy_system_scenario) & \
    ...
    traffic_flow_updated = update_module9_templates(year, mod6_data=traffic_flow_for_Mod9,
                                                    mod9_data=traffic_flow,energy_system_scenario = energy_system_scenario,
                                                    freight_demand_scenario=freight_demand_scenario)

    train_updated = update_module9_templates(year, mod6_data=train_for_Mod9,
                                             mod9_data=train,
                                             energy_system_scenario = energy_system_scenario,
                                             freight_demand_scenario=freight_demand_scenario,)

    refueling_updated = update_module9_templates(year, mod6_data=refueling_for_Mod9,
                                                 mod9_data=refueling,energy_system_scenario = energy_system_scenario,
                                                 freight_demand_scenario=freight_demand_scenario,)

    energy_updated = update_module9_templates(year, mod6_data=energy_for_Mod9,
                                              mod9_data=energy,energy_system_scenario = energy_system_scenario,
                                              freight_demand_scenario=freight_demand_scenario,)

    ### Update Module9 templates with module 7
    energy_updated = update_module7_templates(year, mod6_data=energy_updated,
                                              mod9_data=carbon_intensity_module7,energy_system_scenario = energy_system_scenario,
                                              freight_demand_scenario=freight_demand_scenario,)
    ...
    refueling_updated = update_module8_templates(year, refueling_station_per_temoa_melt,
                                                 refueling_updated,energy_system_scenario = energy_system_scenario,
                                                 freight_demand_scenario=freight_demand_scenario,)
